...
export const FORMAT_DEFS: FormatDef[] = [
  ...
  },
  {
    id: 'triptico',
    label: 'Tríptico',
    description: 'Folleto de tres paneles con caras y pliegues.',
    icon: 'BookOpen',
    ratio: '1.414 / 1',
  },
  {
    id: 'diptico',
    label: 'Díptico',
    description: 'Folleto de dos paneles con pliegue central.',
    icon: 'BookText',
    ratio: '1.414 / 1',
  },
  {
  ...
  {
    id: 'ficha_tecnica',
    label: 'Tarjeta clínica',
    description: 'Tarjeta de bolsillo para referencia a pie de cama.',
    icon: 'CreditCard',
    ratio: '1.586 / 1',
  },
  {
  ...
  {
    id: 'reloj_posicion',
    label: 'Reloj de cambio de posición',
    description: 'Rueda horaria para el cambio de posición del paciente.',
    icon: 'Clock',
    ratio: '1 / 1',
  },
  {
    id: 'ficha_rapida',
    label: 'Ficha rápida',
    description: 'Ficha vertical breve de consulta inmediata.',
    icon: 'FileText',
    ratio: '1 / 1.414',
  },
  {
    ...
    description: 'Protocolo o documento libre.',
    icon: 'FileType2',
    ratio: '1 / 1.414',
  },
]
